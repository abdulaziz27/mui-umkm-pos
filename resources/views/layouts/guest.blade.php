    ...
    <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0">
        ...
        <div class="mb-8">
            <a href="/" class="flex items-center gap-3">
                ...
                <span class="text-2xl font-bold text-primary">{{ config('app.name', 'MUI UMKM POS') }}</span>
            </a>
        </div>

        <!-- Content Card -->
        <div class="w-full sm:max-w-xl px-6 py-8 bg-surface shadow-xl rounded-2xl border border-border mt-6">
            {{ $slot }}
        </div>
